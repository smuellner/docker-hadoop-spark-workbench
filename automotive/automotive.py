...
rdd = accelerations.join(gyroscopes, on=['trip_id', 'timestamp'], how='left_outer').rdd
...
rdd.saveAsHadoopFile("hdfs://192.168.0.104/user/automotive/a.txt", "org.apache.hadoop.mapred.TextOutputFormat")
spark.stop()
